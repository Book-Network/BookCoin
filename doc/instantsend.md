...
This mechanism has been integrated into Bitcore-Node-Book which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bookcoin/insight-api-book#web-socket-api](https://github.com/bookcoin/insight-api-book#web-socket-api) 
* API: [https://github.com/bookcoin/insight-api-book#instantsend-transactions](https://github.com/bookcoin/insight-api-book#instantsend-transactions) 
...
By default, the Book Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Book Core daemon:
