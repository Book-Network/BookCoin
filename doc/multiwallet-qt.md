...
Only requiring some minor changes is book.cpp.
...
Changes to book.cpp
----------------------
book.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
