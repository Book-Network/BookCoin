...
Book Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Book Core, where everyone uses
...
pay attention to for reviewers of Book Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Book Core uses tinyformat, which is type safe. Leave them out to avoid confusion
