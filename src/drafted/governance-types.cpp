...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BookNetwork") type = BookNetwork;
    if(strType == "BookNetworkVariable") type = BookNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BookNetwork) s = "BookNetwork";
    if(type == BookNetworkVariable) s = "BookNetworkVariable";
