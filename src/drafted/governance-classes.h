 ...
 *
 *   // network
 *   CBookNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bookcoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBookNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: BookNetwork
// //   -- signature requirements : Key1(User)
// class CBookNetworkVariable : public CGovernanceObject
// {
// private:
