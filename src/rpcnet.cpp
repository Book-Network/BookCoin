...
UniValue getpeerinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"subver\": \"/Book Core:x.x.x/\",  (string) The string version\n"
...
UniValue getaddednodeinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "    \"addresses\" : [\n"
            "       {\n"
            "         \"address\" : \"192.168.0.201:17817\",  (string) The book server host and port\n"
...
static UniValue GetNetworksInfo()
{
    ...
    for(int n=0; n<NET_MAX; ++n)
    {
        ...
        obj.push_back(Pair("proxy_randomize_cbooktials", proxy.randomize_cbooktials));
...
UniValue getnetworkinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"subversion\": \"/Book Core:x.x.x/\", (string) the server subversion string\n"
