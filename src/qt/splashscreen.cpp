    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("Book Core");
    ...
    QString copyrightTextBook   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Book Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextBook);
