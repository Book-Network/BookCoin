    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Book Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Book address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and book: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Book Core"), this);
    aboutAction->setStatusTip(tr("Show information about Book Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Book Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Book addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Book addresses"));
    ...
    openAction->setStatusTip(tr("Open a book: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Book Core help message to get a list with possible Book Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Book Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Book network", "", count));
}
...
{
    QString strTitle = tr("Book Core"); // default title
