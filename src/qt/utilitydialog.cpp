    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Book Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Book Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  book-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Book in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an booktive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 BOOK, 0.1 BOOK, 1 BOOK and 10 BOOK -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bookcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://bookcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Book Core is shutting down...") + "<br /><br />" +
