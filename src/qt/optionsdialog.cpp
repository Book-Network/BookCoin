    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BOOK-light"), QVariant("light"));
    ui->theme->addItem(QString("BOOK-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BOOK-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BOOK-traditional"), QVariant("trad"));
