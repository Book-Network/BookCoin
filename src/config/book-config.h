/* src/config/book-config.h.  Generated from book-config.h.in by configure.  */
/* src/config/book-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Book Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Book Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NicholasAdmin/Book/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Book Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Book Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bookcore"
