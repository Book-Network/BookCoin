...
static bool Socks5(const std::string& strDest, int port, const ProxyCbooktials *auth, SOCKET& hSocket)
{
...
static bool ConnectThroughProxy(const proxyType &proxy, const std::string& strDest, int port, SOCKET& hSocketRet, int nTimeout, bool *outProxyConnectionFailed)
{
    ...
    if (proxy.randomize_cbooktials) {
        ProxyCbooktials random_auth;
