...
Book Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
[Tags](https://github.com/Book/Book/tags) are created to indicate new official,l.0.0
stable release versions of Book Core.
